...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiadmissionregistrationv1alpha1Rule
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiadmissionregistrationv1alpha1Rule class.
        /// </summary>
        public Iok8sapiadmissionregistrationv1alpha1Rule()
        {
            CustomInit();
        }
        ...
        public Iok8sapiadmissionregistrationv1alpha1Rule(IList<string> apiGroups = default(IList<string>), IList<string> apiVersions = default(IList<string>), IList<string> resources = default(IList<string>))
        {
            ApiGroups = apiGroups;
