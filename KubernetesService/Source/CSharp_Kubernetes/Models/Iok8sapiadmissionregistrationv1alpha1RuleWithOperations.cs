...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiadmissionregistrationv1alpha1RuleWithOperations
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiadmissionregistrationv1alpha1RuleWithOperations class.
        /// </summary>
        public Iok8sapiadmissionregistrationv1alpha1RuleWithOperations()
        {
            CustomInit();
        }
        ...
        public Iok8sapiadmissionregistrationv1alpha1RuleWithOperations(IList<string> apiGroups = default(IList<string>), IList<string> apiVersions = default(IList<string>), IList<string> operations = default(IList<string>), IList<string> resources = default(IList<string>))
        {
            ApiGroups = apiGroups;
