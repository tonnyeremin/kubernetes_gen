...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapiappsv1beta1StatefulSetStatus
    {
        ...
        public Iok8sapiappsv1beta1StatefulSetStatus(int replicas, int? collisionCount = default(int?), int? currentReplicas = default(int?), string currentRevision = default(string), long? observedGeneration = default(long?), int? readyReplicas = default(int?), string updateRevision = default(string), int? updatedReplicas = default(int?))
        {
