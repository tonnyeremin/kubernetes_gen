...
namespace KubernetesService.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapiappsv1beta2ReplicaSetSpec
        /// class.
        /// </summary>
        ...
        public Iok8sapiappsv1beta2ReplicaSetSpec(int? minReadySeconds = default(int?), int? replicas = default(int?), Iok8sapimachinerypkgapismetav1LabelSelector selector = default(Iok8sapimachinerypkgapismetav1LabelSelector), Iok8sapicorev1PodTemplateSpec template = default(Iok8sapicorev1PodTemplateSpec))
        {
