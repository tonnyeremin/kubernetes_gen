...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapiautoscalingv2beta1HorizontalPodAutoscalerStatus
    {
        ...
        public Iok8sapiautoscalingv2beta1HorizontalPodAutoscalerStatus(IList<Iok8sapiautoscalingv2beta1HorizontalPodAutoscalerCondition> conditions, IList<Iok8sapiautoscalingv2beta1MetricStatus> currentMetrics, int currentReplicas, int desiredReplicas, System.DateTime? lastScaleTime = default(System.DateTime?), long? observedGeneration = default(long?))
        {
