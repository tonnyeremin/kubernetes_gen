...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapibatchv1JobCondition
    {
        ...
        /// transition.</param>
        public Iok8sapibatchv1JobCondition(string status, string type, System.DateTime? lastProbeTime = default(System.DateTime?), System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
