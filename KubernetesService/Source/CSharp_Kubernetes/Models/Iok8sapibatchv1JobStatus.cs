...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapibatchv1JobStatus
    {
        ...
        /// Succeeded.</param>
        public Iok8sapibatchv1JobStatus(int? active = default(int?), System.DateTime? completionTime = default(System.DateTime?), IList<Iok8sapibatchv1JobCondition> conditions = default(IList<Iok8sapibatchv1JobCondition>), int? failed = default(int?), System.DateTime? startTime = default(System.DateTime?), int? succeeded = default(int?))
        {
            Active = active;
