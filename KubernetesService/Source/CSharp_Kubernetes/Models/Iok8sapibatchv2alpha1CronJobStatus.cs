...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapibatchv2alpha1CronJobStatus
    {
        ...
        public Iok8sapibatchv2alpha1CronJobStatus(IList<Iok8sapicorev1ObjectReference> active = default(IList<Iok8sapicorev1ObjectReference>), System.DateTime? lastScheduleTime = default(System.DateTime?))
        {
            Active = active;
