...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapicertificatesv1beta1CertificateSigningRequestCondition
    {
        ...
        public Iok8sapicertificatesv1beta1CertificateSigningRequestCondition(string type, System.DateTime? lastUpdateTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
