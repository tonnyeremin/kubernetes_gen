...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapicorev1NodeCondition
    {
        ...
        /// transition.</param>
        public Iok8sapicorev1NodeCondition(string status, string type, System.DateTime? lastHeartbeatTime = default(System.DateTime?), System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
