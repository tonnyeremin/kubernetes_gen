...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapicorev1PersistentVolumeClaimCondition
    {
        ...
        public Iok8sapicorev1PersistentVolumeClaimCondition(string status, string type, System.DateTime? lastProbeTime = default(System.DateTime?), System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
