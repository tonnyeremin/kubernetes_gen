...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapicorev1PodCondition
    {
        ...
        public Iok8sapicorev1PodCondition(string status, string type, System.DateTime? lastProbeTime = default(System.DateTime?), System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
