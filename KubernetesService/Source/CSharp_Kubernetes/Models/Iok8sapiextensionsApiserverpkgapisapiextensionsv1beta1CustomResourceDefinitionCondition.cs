...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceDefinitionCondition
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceDefinitionCondition()
        {
            CustomInit();
        }
        ...
        public Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceDefinitionCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
