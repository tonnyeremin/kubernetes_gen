...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceDefinitionNames
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceDefinitionNames()
        {
            CustomInit();
        }
        ...
        /// &lt;kind&gt;</param>
        public Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceDefinitionNames(string kind, string plural, string listKind = default(string), IList<string> shortNames = default(IList<string>), string singular = default(string))
        {
            Kind = kind;
            ListKind = listKind;
            Plural = plural;
