...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapiextensionsv1beta1ReplicaSetCondition
    {
        ...
        /// transition.</param>
        public Iok8sapiextensionsv1beta1ReplicaSetCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
