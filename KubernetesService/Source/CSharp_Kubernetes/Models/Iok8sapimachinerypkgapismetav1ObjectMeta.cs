...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapimachinerypkgapismetav1ObjectMeta
    {
        ...
        public Iok8sapimachinerypkgapismetav1ObjectMeta(IDictionary<string, string> annotations = default(IDictionary<string, string>), string clusterName = default(string), System.DateTime? creationTimestamp = default(System.DateTime?), long? deletionGracePeriodSeconds = default(long?), System.DateTime? deletionTimestamp = default(System.DateTime?), IList<string> finalizers = default(IList<string>), string generateName = default(string), long? generation = default(long?), Iok8sapimachinerypkgapismetav1Initializers initializers = default(Iok8sapimachinerypkgapismetav1Initializers), IDictionary<string, string> labels = default(IDictionary<string, string>), string name = default(string), string namespaceProperty = default(string), IList<Iok8sapimachinerypkgapismetav1OwnerReference> ownerReferences = default(IList<Iok8sapimachinerypkgapismetav1OwnerReference>), string resourceVersion = default(string), string selfLink = default(string), string uid = default(string))
        {
