...
namespace KubernetesService.Models
{
    ...
    /// information.
    /// </summary>
    public partial class Iok8sapimachinerypkgversionInfo
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapimachinerypkgversionInfo
        /// class.
        /// </summary>
        public Iok8sapimachinerypkgversionInfo()
        {
            CustomInit();
        }
        ...
        /// class.
        /// </summary>
        public Iok8sapimachinerypkgversionInfo(string buildDate, string compiler, string gitCommit, string gitTreeState, string gitVersion, string goVersion, string major, string minor, string platform)
        {
            BuildDate = buildDate;
            Compiler = compiler;
            GitCommit = gitCommit;
