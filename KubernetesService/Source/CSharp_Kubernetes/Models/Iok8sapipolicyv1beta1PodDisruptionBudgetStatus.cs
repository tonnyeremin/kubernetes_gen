...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapipolicyv1beta1PodDisruptionBudgetStatus
    {
        ...
        public Iok8sapipolicyv1beta1PodDisruptionBudgetStatus(int currentHealthy, int desiredHealthy, IDictionary<string, System.DateTime?> disruptedPods, int disruptionsAllowed, int expectedPods, long? observedGeneration = default(long?))
        {
