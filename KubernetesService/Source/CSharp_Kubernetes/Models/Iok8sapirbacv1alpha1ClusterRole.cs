...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapirbacv1alpha1ClusterRole
    {
        /// <summary>
        ...
        public Iok8sapirbacv1alpha1ClusterRole(IList<Iok8sapirbacv1alpha1PolicyRule> rules, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
