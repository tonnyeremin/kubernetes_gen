...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapirbacv1alpha1ClusterRoleBinding
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapirbacv1alpha1ClusterRoleBinding class.
        /// </summary>
        public Iok8sapirbacv1alpha1ClusterRoleBinding()
        {
            CustomInit();
        }
        ...
        public Iok8sapirbacv1alpha1ClusterRoleBinding(Iok8sapirbacv1alpha1RoleRef roleRef, IList<Iok8sapirbacv1alpha1Subject> subjects, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
