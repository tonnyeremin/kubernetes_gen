...
namespace KubernetesService.Models
{
    ...
    /// the rule applies to.
    /// </summary>
    public partial class Iok8sapirbacv1alpha1PolicyRule
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapirbacv1alpha1PolicyRule
        /// class.
        /// </summary>
        public Iok8sapirbacv1alpha1PolicyRule()
        {
            CustomInit();
        }
        ...
        public Iok8sapirbacv1alpha1PolicyRule(IList<string> verbs, IList<string> apiGroups = default(IList<string>), IList<string> nonResourceURLs = default(IList<string>), IList<string> resourceNames = default(IList<string>), IList<string> resources = default(IList<string>))
        {
            ApiGroups = apiGroups;
