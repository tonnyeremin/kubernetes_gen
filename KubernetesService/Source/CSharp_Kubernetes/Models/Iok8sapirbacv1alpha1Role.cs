...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapirbacv1alpha1Role
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapirbacv1alpha1Role class.
        /// </summary>
        public Iok8sapirbacv1alpha1Role()
        {
            CustomInit();
        }
        ...
        public Iok8sapirbacv1alpha1Role(IList<Iok8sapirbacv1alpha1PolicyRule> rules, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
        ...
        public IList<Iok8sapirbacv1alpha1PolicyRule> Rules { get; set; }
