...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapirbacv1alpha1RoleBinding
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapirbacv1alpha1RoleBinding
        /// class.
        /// </summary>
        public Iok8sapirbacv1alpha1RoleBinding()
        {
            CustomInit();
        }
        ...
        public Iok8sapirbacv1alpha1RoleBinding(Iok8sapirbacv1alpha1RoleRef roleRef, IList<Iok8sapirbacv1alpha1Subject> subjects, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
        ...
        public Iok8sapirbacv1alpha1RoleRef RoleRef { get; set; }
        ...
        public IList<Iok8sapirbacv1alpha1Subject> Subjects { get; set; }
