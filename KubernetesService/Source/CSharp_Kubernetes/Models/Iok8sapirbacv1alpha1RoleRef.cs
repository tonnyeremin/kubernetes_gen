...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapirbacv1alpha1RoleRef
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapirbacv1alpha1RoleRef
        /// class.
        /// </summary>
        public Iok8sapirbacv1alpha1RoleRef()
        {
            CustomInit();
        }
        ...
        /// referenced</param>
        public Iok8sapirbacv1alpha1RoleRef(string apiGroup, string kind, string name)
        {
            ApiGroup = apiGroup;
            Kind = kind;
            Name = name;
