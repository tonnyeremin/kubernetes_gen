...
namespace KubernetesService.Models
{
    ...
    /// </summary>
    public partial class Iok8sapirbacv1alpha1Subject
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapirbacv1alpha1Subject
        /// class.
        /// </summary>
        ...
        /// error.</param>
        public Iok8sapirbacv1alpha1Subject(string kind, string name, string apiVersion = default(string), string namespaceProperty = default(string))
        {
