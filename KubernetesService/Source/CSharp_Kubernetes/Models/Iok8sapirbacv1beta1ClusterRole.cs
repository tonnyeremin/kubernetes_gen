...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8sapirbacv1beta1ClusterRole
    {
        ...
        public Iok8sapirbacv1beta1ClusterRole(IList<Iok8sapirbacv1beta1PolicyRule> rules, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
