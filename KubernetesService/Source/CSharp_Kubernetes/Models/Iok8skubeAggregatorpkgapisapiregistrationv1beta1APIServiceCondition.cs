...
namespace KubernetesService.Models
{
    ...
    public partial class Iok8skubeAggregatorpkgapisapiregistrationv1beta1APIServiceCondition
    {
        ...
        public Iok8skubeAggregatorpkgapisapiregistrationv1beta1APIServiceCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
